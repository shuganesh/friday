...
class ImageModel extends Model
{
    ...
    protected $allowedFields = ['image', 'type', 'status', 'user_id'];
    ...
    public function UserDetails($email='', $password="")
    {
        ...
        if ($email AND $password) {
            ...
            $this->where("username = '$email' AND password = '$password' AND mem_type = '1' OR email = '$email' AND password = '$password' AND mem_type = '1' ");
